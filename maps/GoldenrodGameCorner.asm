...
DEF GOLDENRODGAMECORNER_CLEFAIRY_COINS EQU 1400
DEF GOLDENRODGAMECORNER_MAREANIE_COINS EQU 2000
DEF GOLDENRODGAMECORNER_PORYGON_COINS  EQU 2700
...
;	ifequalfwd $1, .abra
	ifequalfwd $1, .cubone
	ifequalfwd $2, .clefairy
	ifequalfwd $3, .mareanie
	jumpopenedtext GoldenrodGameCornerPrizeVendorQuitText
...
.mareanie
	checkcoins GOLDENRODGAMECORNER_MAREANIE_COINS
	ifequal $2, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	getmonname SNEASEL, $0 ; CHANGE TO MAREANIE LATER
	scall GoldenrodGameCornerPrizeVendor_ConfirmPurchaseScript
	iffalse_jumpopenedtext GoldenrodGameCornerPrizeVendorQuitText
	waitsfx
	playsound SFX_TRANSACTION
	writetext GoldenrodGameCornerPrizeVendorHereYouGoText
	waitbutton
	givepoke SNEASEL, HISUIAN_FORM, 14 ; CHANGE TO MAREANIE LATER
	iffalse_jumpopenedtext GoldenrodGameCornerPrizeVendorNoMoreRoomText
	setmonval SNEASEL, HISUIAN_FORM ; CHANGE TO MAREANIE LATER
	special Special_GameCornerPrizeMonCheckDex
	takecoins GOLDENRODGAMECORNER_MAREANIE_COINS
	sjump .loop
...
;	db "Abra        {d:GOLDENRODGAMECORNER_ABRA_COINS}@"
	...
	db "Sneasel    {d:GOLDENRODGAMECORNER_MAREANIE_COINS}@" ; CHANGE TO MAREANIE LATER
	db "Cancel@"
