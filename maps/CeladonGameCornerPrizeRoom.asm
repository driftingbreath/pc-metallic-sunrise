...
DEF CELADONGAMECORNERPRIZEROOM_MR__MIME_COINS EQU 2048
DEF CELADONGAMECORNERPRIZEROOM_EEVEE_COINS    EQU 4096
DEF CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 8192
