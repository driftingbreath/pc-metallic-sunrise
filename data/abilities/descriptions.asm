...
StaticDescription:
	text  "May paralyze foes"
	next1 "that make contact."
	done
...
;	next1 "foe's barriers."
	text  "Bypasses barriers"
	next1 "and substitutes."
	done
