...
ButterfreeEvosAttacks:
	...
	db 23, SUPERSONIC
	db 25, SAFEGUARD
	db 29, REFLECT ; Whirlwind → Reflect (why in the hell did it used to have Hypnosis AFTER SLEEP POWDER)
	db 31, BUG_BUZZ
	db 35, HEALINGLIGHT ; Rage Powder → new move
	db 37, AIR_SLASH ; Captivate → new move
	db 41, HEALINGLIGHT ; Tailwind → new move
	db 43, PSYCHIC_M
	db 47, HURRICANE ; Quiver Dance → big explodey kill move
	db -1 ; no more level-up moves
...
SpearowEvosAttacks:
	...
	db 15, AERIAL_ACE
	db 18, LOW_KICK ; Mirror Move → new addition (previously Swift)
...
FearowEvosAttacks:
	...
	db 41, DRILL_PECK
	db 45, REVERSAL
	db 50, DOUBLE_EDGE ; Drill Run → tutor move
	db -1 ; no more level-up moves
...
MagikarpEvosAttacks:
	...
	db 8, TACKLE
	db 16, WATER_GUN
	db 24, REVERSAL ; Flail → event move
	db -1 ; no more level-up moves
...
ChikoritaEvosAttacks:
	...
	db 1, GROWL
	db 6, RAZOR_LEAF
	db 9, HEALINGLIGHT ; Synthesis → similar move
	db 12, LIGHT_SCREEN
	db 12, REFLECT
	db 17, SING
...
QuilavaEvosAttacks:
	...
	evo_data EVOLVE_ITEM, DUSK_STONE, TYPHLOSION, HISUIAN_FORM ; I understand why they didn't, but purple Typh is my boy
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, LEER
	db 6, SMOKESCREEN
...
FurretEvosAttacks:
	...
	db 20, SUPER_FANG ; Follow Me → HGSS tutor move
	db 24, DIG
	db 28, HEADBUTT ; Slam → tutor move
	db 32, SUCKER_PUNCH
	db 36, REST
...
SpinarakEvosAttacks:
	...
	db 50, SUCKER_PUNCH ; Sticky Web → new move
	db -1 ; no more level-up moves
...
AriadosEvosAttacks:
	...
	db 58, SUCKER_PUNCH ; Sticky Web → new move
	db -1 ; no more level-up moves
...
TogepiEvosAttacks:
	...
	db 37, SAFEGUARD
	db 41, BATON_PASS
	db 45, PLAY_ROUGH ; After You → Sw/Sh move
...
;	evo_data EVOLVE_ITEM, SHINY_STONE, SOLAREEF - in anticipation for Solareef
	db -1 ; no more evolutions
	db 1, CHARM ; so adorable. so charming. very demure.
	db 1, ROLLOUT
	db 1, DEFENSE_CURL
	db 1, WATER_GUN
	db 5, ENDURE
	db 10, CONFUSE_RAY ; Confuse Ray this early is for the Lv10 fishing encounter, it is a MONSTER with another damaging move here
	db 15, HORN_ATTACK
	db 20, ANCIENTPOWER
	db 25, BUBBLE_BEAM
	db 30, REVERSAL ; she is going to. to beat you to death
	db 35, RECOVER
	db 40, POWER_GEM
	db 45, BARRIER ; great barrier reef!
	db 50, HYDRO_PUMP
	db 55, COUNTER
	db -1 ; no more level-up moves

;	OLD LEARNSET BELOW - JUST IN CASE I FUCK SOMETHING UP
;	
;	db 1, CHARM
;	db 1, DEFENSE_CURL ; Harden → similar move
;	db 1, TACKLE
;	db 4, WATER_GUN ; Bubble → similar move
;	db 9, ROLLOUT ; Recover → TM move
;	db 12, HORN_ATTACK
;	db 15, SAFEGUARD ; Refresh → egg move
;	db 18, BUBBLE_BEAM
;	db 20, ANCIENTPOWER
;	db 22, ICICLE_SPEAR ; Spike Cannon → egg move
;	db 24, CONFUSE_RAY ; Lucky Chant → egg move
;	db 27, ENDURE ; Brine → Endure
;	db 29, ROCK_BLAST
;	db 32, BARRIER ; Iron Defense → similar move
;	db 32, AMNESIA
...
CorsolaGalarianEvosAttacks:
	...
	db -1 ; no more evolutions
	db 1, SCARY_FACE ; eek! a ghost
	db 1, ROLLOUT ; added for parity with base Corsola and it gets this through tutor anyway
	db 1, DEFENSE_CURL ; Harden → similar move
	db 1, ASTONISH
	db 5, DISABLE
	db 10, HAZE ; Spite → egg move
	db 15, HEADBUTT ; as a parallel to base Corsola's Horn Attack
	db 20, ANCIENTPOWER
	db 25, HEX
	db 30, CURSE
...
LeafeonEvosAttacks:
	...
	db 41, DOUBLE_EDGE ; Last Resort → tutor move
	db 45, POWER_WHIP ; Leaf Blade → Power Whip (used to be Sunny Day here, ew)
	db -1 ; no more level-up moves
