...
;else
;	db  65,  65, 115,  35,  95, 115 ; 490 BST - commented out in anticipation of Solareef
	;   hp  atk  def  spe  sat  sdf
;endc
...
;if DEF(FAITHFUL)
	db 113 ; base exp
;else
;	db 128 ; base exp - commented out in anticipation of Solareef
;endc
	db NO_ITEM, HARD_STONE ; held items
	dn GENDER_F75, HATCH_MEDIUM_FAST ; gender ratio, step cycles to hatch

	abilities_for CORSOLA, SOLID_ROCK, NATURAL_CURE, REGENERATOR
