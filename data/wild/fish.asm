...
.Shore_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, KRABBY,     10
	fishentry 100 percent,     0,          10 ; corsola morn/day, staryu eve/night
.Shore_Good:
	fishentry  35 percent,     MAGIKARP,   20
	fishentry  70 percent,     KRABBY,     20
	fishentry  90 percent + 1, 0,          20 ; corsola morn/day, staryu eve/night
...
.Ocean_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, TENTACOOL,  10
...
.Well_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, GOLDEEN,    10
...
.Well_Good:
	...
	fishentry 100 percent,     SEAKING,    20
.Lake_Super:
.River_Super:
	fishentry  40 percent,     HORSEA,     40
	fishentry  70 percent,     GOLDEEN,    40
	fishentry  90 percent + 1, SEADRA,     40
...
.Pond_Super:
	...
	fishentry  90 percent + 1, POLIWHIRL,  40
	fishentry 100 percent,     SEAKING,    40

.Dratini_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, MAGIKARP,   10
...
.Qwilfish_Swarm_Old:
	fishentry  60 percent + 1, MAGIKARP,   5
	fishentry  80 percent + 1, QWILFISH,   5
...
.Remoraid_Swarm_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, REMORAID,   10
...
.Dratini_2_Good:
	...
	fishentry  90 percent + 1, DRATINI,    10
	fishentry 100 percent,     DRATINI,    10
.Dratini_2_Super:
...
.Qwilfish_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, TENTACOOL,  10
	fishentry 100 percent,     CHINCHOU,   10
.Qwilfish_Good:
	fishentry  35 percent,     QWILFISH,   20
	fishentry  70 percent,     TENTACOOL,  20
...
.Remoraid_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, POLIWAG,    10
	fishentry 100 percent,     REMORAID,   10
.Remoraid_Good:
	fishentry  35 percent,     REMORAID,   20
...
.Hisuian_Qwilfish_Old:
	fishentry  60 percent + 1, MAGIKARP,   10
	fishentry  80 percent + 1, TENTACOOL,  10
	fishentry 100 percent,     QWILFISH,   HISUIAN_FORM,   10
