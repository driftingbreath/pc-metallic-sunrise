...
if !DEF(FAITHFUL)
	text "An adorable slap"
	next "that hits twice."
	done
endc
...
ScaldDescription: ; reworked as "Steam Shot"
if !DEF(FAITHFUL)
	text "Scalding-hot steam"
	next "that may burn."
;	text "Scalding-hot water"
;	next "lowers Attack."
	done
endc
EmberDescription:
...
FlashDescription:
	text "A blinding spark"
	next "lowers accuracy."
	done

MudSlapDescription:
	text "Scatters mud that"
	next "lowers accuracy."
	done
...
HornAttackDescription:
	text "Jabs with a horn"
if DEF(FAITHFUL)
	next "to attack the foe."
else
	next "to break Defense."
endc
	done
