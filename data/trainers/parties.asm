...
GruntMGroup:
	...
	; party
	dbp 7, GASTLY, MALE
		db ABIL_GASTLY_CLEAR_BODY | NAT_NEUTRAL
	dbp 11, RATTATA, FEMALE | ALOLAN_FORM
		db ABIL_RATTATA_ALOLAN_GLUTTONY | NAT_NEUTRAL
	dbp 9, TENTACOOL, FEMALE
		db ABIL_TENTACOOL_CLEAR_BODY | NAT_NEUTRAL
	dbp 9, ZUBAT, FEMALE
		db ABIL_ZUBAT_ANTICIPATION | NAT_NEUTRAL
	db -1 ; end
	...
	; GRUNTM
	db "Rico@" ; the Slowpoke Well suck!
	db TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 9, LEDYBA, MALE
		db ABIL_LEDYBA_EARLY_BIRD | NAT_NEUTRAL
		db SUPERSONIC, DRAIN_PUNCH, MACH_PUNCH, NO_MOVE
	dbp 9, ZUBAT, MALE
		db ABIL_ZUBAT_ANTICIPATION | NAT_NEUTRAL
		db SUPERSONIC, ABSORB, ASTONISH, NO_MOVE
	dbp 11, PARAS, MALE
		db ABIL_PARAS_EFFECT_SPORE | NAT_NEUTRAL
		db SLEEP_POWDER, ABSORB, SCRATCH, NO_MOVE
	db -1 ; end
...
BattleGirlGroup:
	...
	dbp LEVEL_FROM_BADGES + 10, URSARING, MALE
		db PROTECT_PADS, FAKE_PERFECT_DVS, ABIL_URSARING_QUICK_FEET | NAT_ATK_UP_SATK_DOWN
...
ProfElmGroup:
	...
	db TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp LEVEL_FROM_BADGES + 3, HOOTHOOT, MALE
		db ABIL_HOOTHOOT_INSOMNIA | NAT_NEUTRAL
		db CONFUSION, HYPNOSIS, GROWL, PECK
	dbp LEVEL_FROM_BADGES + 4, JIGGLYPUFF, MALE
		db ABIL_JIGGLYPUFF_CUTE_CHARM | NAT_NEUTRAL
		db DIZZY_PUNCH, DISARM_VOICE, DEFENSE_CURL, SING
	dbp LEVEL_FROM_BADGES + 6, CYNDAQUIL
		db ABIL_CYNDAQUIL_BLAZE | NAT_NEUTRAL
		db EMBER, QUICK_ATTACK, SMOKESCREEN, LEER
	dbp LEVEL_FROM_BADGES + 6, CHIKORITA
		db ABIL_CHIKORITA_OVERGROW | NAT_NEUTRAL
		db RAZOR_LEAF, HEALINGLIGHT, GROWL, SING
	dbp LEVEL_FROM_BADGES + 6, TOTODILE
		db ABIL_TOTODILE_TORRENT | NAT_NEUTRAL
		db WATER_GUN, BITE, SCARY_FACE, RAGE
	db -1 ; end
